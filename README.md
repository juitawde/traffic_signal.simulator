...
The system displays each signal with **colored output and emoji indicators**, along with a **countdown timer** showing the time remaining before the next signal change.

The simulation runs in a loop until the user chooses to stop or exit the program.
...
- **Menu-driven interface** with Start, Stop, and Exit options
- Ability to **continue or stop the simulation after each cycle**
...
- Standard Libraries:
  ...
  - `<thread>` for time delay
  - `<chrono>` for second-based timing
...
<img width="1181" height="545" alt="Screenshot 2026-03-07 at 3 45 32 AM" src="https://github.com/user-attachments/assets/c9cd276b-32b3-4d35-b1c6-069cad8cad16" />
...
- Vehicle flow analysis and statistics
